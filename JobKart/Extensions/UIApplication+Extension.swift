...
extension UIApplication {
    ...
    func setEmp() {
        if let homeNavigation = UIStoryboard.main.instantiateViewController(withClass: SeekarNav.self) {
            self.setRootController(for: homeNavigation)
        }
    }
    
    func setSeeker() {
        if let homeNavigation = UIStoryboard.main.instantiateViewController(withClass:  EmpNav.self) {
            self.setRootController(for: homeNavigation)
        }
    }
